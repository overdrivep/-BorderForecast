...
public class Day5PointDAO extends DAO<DayPointDTO> implements DayPointImpl {
	private static final String SELECT = "select * from day5_point where event_id = ?";

	private static Day5PointDAO instance;

	private Day5PointDAO(){}

	public static Day5PointDAO getInstance() {
		if(null == instance) {
			instance = new Day5PointDAO();
		}
		return instance;
	}
