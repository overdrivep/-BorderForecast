...
public class Day1PointDAO extends DAO<DayPointDTO> implements DayPointImpl {
	private static final String SELECT = "select * from day1_point where event_id = ?";

	private static Day1PointDAO instance;

	private Day1PointDAO(){}

	public static Day1PointDAO getInstance() {
		if(null == instance) {
			instance = new Day1PointDAO();
		}
		return instance;
	}
