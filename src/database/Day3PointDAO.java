...
public class Day3PointDAO extends DAO<DayPointDTO> implements DayPointImpl {
	private static final String SELECT = "select * from day3_point where event_id = ?";

	private static Day3PointDAO instance;

	private Day3PointDAO(){}

	public static Day3PointDAO getInstance() {
		if(null == instance) {
			instance = new Day3PointDAO();
		}
		return instance;
	}
