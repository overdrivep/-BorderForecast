...
public class Day7PointDAO extends DAO<DayPointDTO> implements DayPointImpl {
	private static final String SELECT = "select * from day7_point where event_id = ?";

	private static Day7PointDAO instance;

	private Day7PointDAO(){}

	public static Day7PointDAO getInstance() {
		if(null == instance) {
			instance = new Day7PointDAO();
		}
		return instance;
	}
