...
public class Day9PointDAO extends DAO<DayPointDTO> implements DayPointImpl {
	private static final String SELECT = "select * from day9_point where event_id = ?";

	private static Day9PointDAO instance;

	private Day9PointDAO(){}

	public static Day9PointDAO getInstance() {
		if(null == instance) {
			instance = new Day9PointDAO();
		}
		return instance;
	}
