...
public class Day4PointDAO extends DAO<DayPointDTO> implements DayPointImpl {
	private static final String SELECT = "select * from day4_point where event_id = ?";

	private static Day4PointDAO instance;

	private Day4PointDAO(){}

	public static Day4PointDAO getInstance() {
		if(null == instance) {
			instance = new Day4PointDAO();
		}
		return instance;
	}
